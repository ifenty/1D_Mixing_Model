...
def plot_alpha_comparison(results: dict, scenario_name: str):
    ...
    labels = {
        ...
        (30.0, 2, True): "α=30.0 + mxl_method2 + surf",
    }
...
def main():
    ...
    # Test configurations
    test_configs = [
        (1.0, 0, False, "Default (α=1.0)"),
        (30.0, 0, False, "ECCOv4r4 α=30 (mxl_method=0)"),
        (30.0, 2, True, "ECCOv4r4 full (α=30, mxl_method=2, surf=true)"),
    ]
